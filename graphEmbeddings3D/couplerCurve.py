...
from graphEmbeddings3D.graphCouplerCurve import *
from graphEmbeddings3D.axel_vis import *

UI_MainWindow, MainWindow = loadUiType(os.path.dirname(os.path.realpath(__file__))+"/couplerCurve.ui")

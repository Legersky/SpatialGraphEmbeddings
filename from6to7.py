...
for i in range(0, 10):
    ...
    alg6 = AlgRealEmbeddings('Max6vertices', num_phi=12, num_theta=12,  name='rnd_6vert_for_7')
    ...
    alg = AlgRealEmbeddings('Max7vertices', name='7vert_from_6vert_1st_phase_'+name6)
    ...
    alg2 = AlgRealEmbeddings('Max7vertices', name='2nd_phase_'+name1st)
